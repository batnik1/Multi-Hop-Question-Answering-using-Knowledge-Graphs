...
class Experiment:
    ...
    def write_embedding_files(self, model):
        ...
        data_folder = "MLRC2020-EmbedKGQA/data/data/%s/" % self.dataset
    ...
    def train_and_eval(self, d):
        ...
        f = open('MLRC2020-EmbedKGQA/data/data/' + self.dataset +'/entities.dict', 'w')
        for key, value in self.entity_idxs.items():
            f.write(key + '\t' + str(value) +'\n')
        f.close()
        f = open('MLRC2020-EmbedKGQA/data/data/' + self.dataset + '/relations.dict', 'w')
...
if __name__ == '__main__':
    ...
    data_dir = f"MLRC2020-EmbedKGQA/data/data/{dataset}/"

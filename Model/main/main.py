...
def perform_experiment(data_path, mode, entity_path, relation_path, entity_dict, relation_dict, neg_batch_size, batch_size, shuffle, num_workers, nb_epochs, embedding_dim, hidden_dim, relation_dim, gpu, use_cuda,patience, freeze, validate_every, num_hops, lr, entdrop, reldrop, scoredrop, l3_reg, model_name, decay, ls, w_matrix, bn_list, kg_type, valid_data_path=None, test_data_path=None):
    ...
    #="MLRC2020-EmbedKGQA/"
    checkpoint_path = 'MLRC2020-EmbedKGQA/'
    if mode=='train':
...
if args.kg_type == 'half':
    data_path = 'MLRC2020-EmbedKGQA/data/data/QA_data/MetaQA/qa_train_' + hops + '_half.txt'
else:
    data_path = 'MLRC2020-EmbedKGQA/data/data/QA_data/MetaQA/qa_train_' + hops + '.txt'

valid_data_path = 'MLRC2020-EmbedKGQA/data/data/QA_data/MetaQA/qa_dev_' + hops + '.txt'
test_data_path = 'MLRC2020-EmbedKGQA/data/data/QA_data/MetaQA/qa_test_' + hops + '.txt'

model_name = args.model
kg_type = args.kg_type
print('KG type is', kg_type)
embedding_folder = 'MLRC2020-EmbedKGQA/data/pretrained_models/embeddings/' + model_name + '_MetaQA_' + kg_type
